...
class TestNormalizeDepartureboards(unittest.TestCase):
    def test_filters_only_metro_a(self) -> None:
        payload = {
            "departures": [
                {"route": {"short_name": "A"}, "trip": {"headsign": "Nemocnice Motol"}, "departure_timestamp": {"scheduled": "2030-01-01T10:00:00Z"}},
                {"route": {"short_name": "B"}, "trip": {"headsign": "Zličín"}, "departure_timestamp": {"scheduled": "2030-01-01T10:02:00Z"}},
            ]
        }
        out = normalize_departureboards(payload, metro_line="A")
    ...
    def test_sorts_by_minutes(self) -> None:
        payload = {
            "departures": [
                {"route": {"short_name": "A"}, "trip": {"headsign": "X"}, "departure_timestamp": {"scheduled": "2099-01-01T10:10:00Z"}},
                {"route": {"short_name": "A"}, "trip": {"headsign": "Y"}, "departure_timestamp": {"scheduled": "2099-01-01T10:05:00Z"}},
            ]
        }
        out = normalize_departureboards(payload, metro_line="A")
